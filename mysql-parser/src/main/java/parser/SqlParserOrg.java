 ...
 *
 */
public class SqlParserOrg extends AbstractParser {
  ...
  public SqlParserOrg(final SqlScanner _scanner) {
    super(_scanner);
  }

  public SqlParserOrg(final SqlScanner _scanner, final boolean _trace) {
  ...
  public void stmt() {
    ...
    if (Tokens.CREATE1 == getToken()) {
      createCommand();
    }
    if (Tokens.ALTER1 == getToken()) {
      alterCommand();
    }
    if (Tokens.DROP1 == getToken()) {
      dropCommand();
    }
    if (Tokens.INSERT1 == getToken()) {
      insertCommand();
    }
    if (Tokens.COMMIT1 == getToken()) {
      nextToken();
    }
  ...
  public void alterCommand() {
    ...
    while (Tokens.ADD1 == getToken() || Tokens.CHANGE1 == getToken()) {
      ...
      if (Tokens.CONSTRAINT1 == getToken()) {
        ...
        parseField();
      } else if (Tokens.PRIMARY1 == getToken() || Tokens.KEY1 == getToken() || Tokens.UNIQUE1 == getToken()) {
        parseKey();
      } else {
  ...
  public void addConstraint() {
    ...
    if (Tokens.FOREIGN1 == getToken()) {
      ...
      System.out.println(tabBean.getName());

      KeyBean keyBean = tabBean.getKeyBean(refField);
  ...
  public void parseTable() {
    ...
    if (Tokens.PRIMARY1 == getToken() || Tokens.FOREIGN1 == getToken() || Tokens.KEY1 == getToken()) {
      parseKey();
    }
  ...
  public FieldBean parseField() {
    ...
    if (!m_config.getDataTypeMap().containsKey(type.toUpperCase())) {
      ...
      if (Tokens.COLLATE1 == getToken()) {
        ...
        if (getWord().startsWith("utf"))
          nextToken();
        // if (Tokens.utf8_unicode_ci1 == getToken() || Tokens.utf81 == getToken()) {
        // nextToken();
        // }
      }
      if (Tokens.NOT1 == getToken())
      ...
      if (Tokens.DEFAULT1 == getToken()) {
        ...
        if (Tokens.CURRENT_TIMESTAMP1 == getToken() || Tokens.STR_CONSTANT1 == getToken() || Tokens.NULL1 == getToken()
          ...
          fieldBean.setDefautValue(getWord());
      ...
      if (Tokens.CHECK1 == getToken()) {
        ...
        checkStr += "))";
        fieldBean.setCheckValue(checkStr);
        expect(Tokens.RPAR1);
        expect(Tokens.RPAR1);
      }
